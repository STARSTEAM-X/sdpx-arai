...
หลังกู้คืนทั้ง 3 ครั้ง → **52 passed** เท่าเดิม
...
|---|---|
| จำนวน test | 52 |
| เวลารัน | **0.77 วินาที** (เพดานของวิชาคือ 10 วินาที) |
...
| กฎของ Pairing Engine (P1–P10) | ยังไม่ได้ implement — อยู่ใน Sprint ถัดไป | WS ถัดไปเมื่อทำ US-05/US-06 |
| กฎของ Scoring Engine (S1–S10) | ยังไม่ได้ implement | เมื่อทำ US-10 |
| authorization ข้ามห้องเรียน (US-11) | ยังไม่มีชั้น authorization | เมื่อทำ US-11 |
